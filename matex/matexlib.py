...
class RaizExcpt(Exception):
    """Error lanzado si se intenta realizar la raíz cuadrada de un número
       negativo"""
...
def simplificador2(ecuacion):
    """Función que toma una ecuación de segundo grado ax²+bx=c y devuelve una
       tupla con a,b,c
    >>> ecuacion = 2x²-5x=7
    2,-5,7"""
...
# FÍSICA
def coulomb(desp):
    """Ley de Coulomb F=(k·q1·q2)/d² -> Desp: letra que el programa debe
       hallar"""
