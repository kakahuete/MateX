...
def ayuda2_es():
    ...
    print("La interfaz MateX está diseñada para proporcionar la mayor " +
          "facilidad posible en la interacción entre el usuario y la " +
          "librería MateX")
...
comandos = {"salir:": "Sale de MateX",
            ...
            "comandos:":
            "Muestra una lista de comandos aceptados por el programa",
            "debugging:": "Solo para desarrolladores",
            "aleatorio:":
            "Genera un número aleatorio una vez determinado el rango",
            ...
            "coulomb:":
            "Halla cualquier variable de la ecuación que define la ley " +
            "de Coulomb",
...
def help2_en():
    ...
    print("The MateX interface is designed to offer the most possible ease" +
          " of use regarding to the interaction between the use and " +
          "MateX library")
...
commands = {"exit:": "Exits MateX",
            ...
            "system":
            "Solves a system of two linear equations ax+by=c} dx+ey=f}",
            "quadratic": "Solves a quadratic equation",
            "cross": "Solves a rule of three (cross-multiplication)",
            "coulomb-law":
            "Calculates any variable that appears in Coulomb's law",
            "perimeter":
